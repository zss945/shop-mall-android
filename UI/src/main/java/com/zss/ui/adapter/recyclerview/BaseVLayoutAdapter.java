 ...
 * @author zm
 */
public abstract class BaseVLayoutAdapter<T> extends DelegateAdapter.Adapter<ViewHolder> {
    ...
    public BaseVLayoutAdapter(LayoutHelper helper, int layoutResId) {
        this(helper, layoutResId, null);
    }

    public BaseVLayoutAdapter(LayoutHelper helper, int layoutResId, List<T> data) {
        this.helper = helper;
